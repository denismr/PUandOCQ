...
# Original code obtained at http://web.eecs.umich.edu/~cscott/code.html
# Minimal changes were made to make it compatible with Python 3 and remove lint warnings.
...
def wrapper(X_mixture,X_component):                 
    ...
    N=X_mixture.shape[0]                                                                     
    M=X_component.shape[0]
    _,kernel=compute_best_rbf_kernel_width(X_mixture,X_component)                 
